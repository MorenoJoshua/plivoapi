...
//$query = <<<MYSQL
//INSERT INTO crm.`plivo_test_in` ($fields) VALUES ($values) ON DUPLICATE KEY UPDATE $ifupdate;
//MYSQL;


$toinsert = json_encode($_REQUEST);
$query =<<<MSYQL
insert into `crm`.`plivo_test_in` (`dump`) values ('$toinsert')
MSYQL;
