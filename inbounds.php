...
$client = preg_replace("/[^0-9,.]/", "", $src);

$type = "Inbound";

$sql = "INSERT INTO cdr (callid, type, src, dst, dstuser, date, time, duration, billduration, dispo) VALUES ('$callid', '$type', '$client', '$dst', '$dstuser3', curdate(), curtime(), 'Null', 'Null', 'In-progress') ";
